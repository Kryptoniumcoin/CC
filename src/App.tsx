...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <header className={`fixed w-full top-0 z-50 bg-green-800 text-white py-4 transition-all duration-300 ${isScrolled ? 'shadow-lg' : ''}`}>
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6">
            ...
            <a href="#faq" className="hover:text-green-200">FAQ</a>
          </nav>

          <div className="hidden md:flex items-center space-x-4">
            <a href="tel:+1-8334615733" className="flex items-center space-x-2 bg-green-600 px-4 py-2 rounded-full hover:bg-green-500 transition">
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-green-800 text-white pt-20">
          <nav className="container mx-auto px-4 flex flex-col space-y-4">
            <a href="#services" className="text-lg py-2 hover:text-green-200">Services</a>
            <a href="#about" className="text-lg py-2 hover:text-green-200">About</a>
            <a href="#testimonials" className="text-lg py-2 hover:text-green-200">Testimonials</a>
            <a href="#faq" className="text-lg py-2 hover:text-green-200">FAQ</a>
            <a href="tel:+1-8334615733" className="flex items-center space-x-2 bg-green-600 px-4 py-2 rounded-full hover:bg-green-500 transition w-full justify-center mt-4">
              <Phone className="w-4 h-4" />
              <span>Call Now</span>
            </a>
          </nav>
